...
"Copyright &copy; 2018 Genericoin Developer"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Genericoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Genericoin</b> version", 0));
